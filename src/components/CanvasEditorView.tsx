              ...
              {images.length === 0 ? (
                ...
                images.map((img, index) => (
                  <div
                    ...
                    className={`relative w-40 h-40 rounded-md overflow-hidden border-2 cursor-pointer transition-all duration-200 flex-shrink-0 {/* Tamaño de miniatura aumentado */}
